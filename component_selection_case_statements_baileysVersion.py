...
def print_theoretical(self): # --> make case statements for each
    ...
    if self.opt_obj.topology == 'buck' or self.opt_obj.topology == 'boost':
        ...
        print(
            f'Vdss: {self.opt_obj.fet1.Vdss}, Rds: {self.opt_obj.fet1.Rds * self.opt_obj.fet_normalizer}, Qg: {self.opt_obj.fet1.Qg}, cost: {self.opt_obj.fet1.Cost}, '
            f'area: {self.opt_obj.fet1.Area}')
        print(
            f'Vdss: {self.opt_obj.fet2.Vdss}, Rds: {self.opt_obj.fet2.Rds * self.opt_obj.fet_normalizer}, Qg: {self.opt_obj.fet2.Qg}, '
        ...
        print(f'L: {self.opt_obj.ind1.L}, Irated: {self.opt_obj.ind1.I_rated}, Rdc: {self.opt_obj.ind1.R_dc}, '
        ...
        print(
            f'cap: {self.opt_obj.cap1.Cap_0Vdc}, Vrated: {self.opt_obj.cap1.V_rated}, area: {self.opt_obj.cap1.Area},'
            f'cost: {self.opt_obj.cap1.Cost}')
        print(
            f'cap: {self.opt_obj.cap2.Cap_0Vdc}, Vrated: {self.opt_obj.cap2.V_rated}, area: {self.opt_obj.cap2.Area},'
